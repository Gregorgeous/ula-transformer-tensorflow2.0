...
dataset,text_tokenizer,summaries_tokenizer,texts_max_length,summaries_max_length = dataset_preprocessing_pipeline(input_texts, target_summaries, cutoff_index=1000)
